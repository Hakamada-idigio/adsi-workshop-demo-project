...
public class AttendanceController {
    ...
    public AttendanceRecordResponse clockIn(@RequestBody ClockRequest request) {
        return attendanceService.clockIn(request.employeeId(), request.memo());
    }

    @PostMapping("/clock-out")
    public AttendanceRecordResponse clockOut(@RequestBody ClockRequest request) {
    ...
    public AttendanceRecordResponse updateMemo(
        ...
        return attendanceService.updateMemo(id, request.requesterId(), request.clockInMemo(), request.clockOutMemo());
    }
